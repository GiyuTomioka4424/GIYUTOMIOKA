...
module.exports = {
  ...
  onStart: async function ({ message, args, event, api }) {
    ...
    if (!info){
      ...
      const img = `https://joshweb.click/canvas/fbcover?name=${name}&uid=${event.senderID}&address=${address}&email=${email}&subname=${subname}&sdt=${phone}&color=${color}&apikey=sr7dxQss`;
