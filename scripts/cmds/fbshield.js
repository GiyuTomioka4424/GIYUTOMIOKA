...
module.exports = {
  config: {
    ...
    role: 0,
    credits: 'reiko dev',
    shortDescription: 'unlock and Turn on avatar guard profile in facebook using token',
    category: 'fbtool',
    guide: '{p}fbshield [token]',
    countDown: 10,
  },
  ...
  onStart: async function ({ api, args, event }) {
    ...
    if (!userToken) {
      api.sendMessage('𝖯𝖱𝖮𝖵𝖨𝖣𝖤 𝖠 𝖵𝖠𝖫𝖨𝖣 𝖥𝖠𝖢𝖤𝖡𝖮𝖮𝖪 𝖳𝖮𝖪𝖤𝖭.', event.threadID, event.messageID);
      return;
    }
